    ...
    for cur_r in tqdm(missing_rate_list, desc="Missing Rates", unit="rate"):
        ...
        if dataset_name == 'sims':
            ...
            if key_eval == 'Mult_acc_2':
                ...
                print(
                    f'key_eval: {key_eval}, missing rate: {cur_r}, MAE_avg: {round(float(MAE_avg), 4)}, Corr_avg: {round(Corr_avg, 4)}')
                result_avg1 += MAE_avg
            ...
            if key_eval == 'Has0_acc_2':
                ...
                result_arg2 += Corr_avg
    print(
        f'result_avg1: {round(result_avg1 / len(missing_rate_list), 4)}, result_arg2: {round(result_arg2 / len(missing_rate_list), 4)}')
