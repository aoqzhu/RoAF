...
def main():
    ...
    # missing_rate_list = [{'l': True, 'a': False, 'v': False},
    #                      {'l': False, 'a': True, 'v': False},
    #                      {'l': False, 'a': False, 'v': True},
    #                      {'l': True, 'a': True, 'v': False},
    #                      {'l': True, 'a': False, 'v': True},
    #                      {'l': False, 'a': True, 'v': True},
    #                      {'l': True, 'a': True, 'v': True}
    #                      ]
    ...
    for cur_r in tqdm(missing_rate_list, desc="Missing Rates", unit="rate"):
        ...
        if dataset_name == 'sims':
            ...
            if key_eval == 'Mult_acc_2':
                ...
                print(f'key_eval: {key_eval}, missing rate: {cur_r}, MAE_avg: {round(float(MAE_avg), 4)}, Corr_avg: {round(Corr_avg, 4)}')
                result_avg1 += MAE_avg
                result_arg2 += Corr_avg
        else:
            seed_list = [[1111, 1112, 1113]]
            # for _, cur_seed  in enumerate([1111, 1112, 1113]):
            ...
            if key_eval == 'Has0_acc_2':
                Has0_acc_2_avg = (test_results_list[0]['Has0_acc_2']) / len(seed_list)
                Has0_F1_score_avg = (test_results_list[0]['Has0_F1_score']) / len(seed_list)
                ...
                Non0_acc_2_avg = (test_results_list[0]['Non0_acc_2']) / len(seed_list)
                Non0_F1_score_avg = (test_results_list[0]['Non0_F1_score']) / len(seed_list)
                ...
                Mult_acc_5_avg = (test_results_list[0]['Mult_acc_5']) / len(seed_list)
                print(f'key_eval: {key_eval}, missing rate: {cur_r}, Mult_acc_5_avg: {round(Mult_acc_5_avg,4)}')
                result_avg1 += Mult_acc_5_avg
            elif key_eval == 'Mult_acc_7':
                Mult_acc_7_avg = (test_results_list[0]['Mult_acc_7']) / len(seed_list)
                print(f'key_eval: {key_eval}, missing rate: {cur_r}, Mult_acc_7_avg: {round(Mult_acc_7_avg,4)}')
                result_avg1 += Mult_acc_7_avg
            elif key_eval == 'MAE':
                MAE_avg = (test_results_list[0]['MAE'] ) / len(seed_list)
                Corr_avg = (test_results_list[0]['Corr']) / len(seed_list)
                print(f'key_eval: {key_eval}, missing rate: {cur_r}, MAE_avg: {round(MAE_avg,4)}, Corr_avg: {round(Corr_avg,4)}')
                result_avg1 += MAE_avg
                result_arg2 += Corr_avg
    print(f'result_avg1: {round(result_avg1/len(missing_rate_list), 4)}, result_arg2: {round(result_arg2/len(missing_rate_list),4)}')
